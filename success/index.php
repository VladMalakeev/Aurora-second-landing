...
<head>
    <meta charset="utf-8" />
    <title>alphabet-of-health.com</title>
...
<!--    <div id="userForm">-->
<!--        <p class="formText">Чтобы лучше понимать потребности Вашего организма, нам необходимо узнать Вас лучше.</br>-->
<!--            Пожалуйста, заполните эту <a href="https://forms.gle/fifGTknu7cbFtsHH9" target="_blank">форму</a>, если в данный момет Вам неудобно пройти опрос, Вы можете сделать это позже.</br>-->
<!--            Удачного дня!-->
<!--        </p>-->
<!--    </div>-->
            <fieldset id="socLink">
                <legend id="socText">Мы в социальных сетях</legend>
                <div id="socLinkBlock">
    ...
    <a href="<?php echo $_SERVER['HTTP_REFERER'] ?>">Вернуться обратно</a>
</div>
